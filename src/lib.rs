...
pub use crate::block::{
    audio_block_count, block_count, correction_block_count, decode_stream, decode_stream_muted,
    decoded_sample_count, first_audio_block, first_correction_block, iter_audio_blocks,
    iter_blocks, iter_correction_blocks, iter_decoded_blocks, metadata_block_count, parse_block,
    parse_blocks, stream_total_samples, total_audio_samples, total_block_samples,
    total_correction_payload_bytes, AudioBlockIter, BlockIter, CorrectionBlockIter,
...
pub use crate::encode::{
    encode_block_mono, encode_block_mono_with_decorr, encode_block_stereo,
    encode_block_stereo_joint, encode_block_stereo_with_decorr, encode_stream_mono,

...
pub use crate::encode::{
    ...
    encode_block_mono_searched, encode_block_mono_shifted, encode_block_mono_with_decorr,
    encode_block_stereo, encode_block_stereo_auto, encode_block_stereo_best,
    ...
    encode_block_stereo_shifted, encode_block_stereo_with_decorr, encode_multichannel_stream,
    encode_stream_mono, encode_stream_mono_best, encode_stream_stereo, encode_stream_stereo_best,

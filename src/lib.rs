...
pub use crate::block::{
    ...
    decode_stream, decode_stream_muted, decoded_sample_count, first_audio_block,
    first_correction_block, iter_audio_blocks, iter_blocks, iter_correction_blocks,
    iter_decoded_blocks, metadata_block_count, parse_block, parse_blocks, stream_total_samples,
    total_audio_samples, total_block_samples, total_correction_payload_bytes, AudioBlockIter,
    BlockIter, CorrectionBlockIter, DecodedStream, StreamDecodeIter, UnsupportedBlockFeature,
    WavPackBlock, MAX_DECODE_SAMPLES_PER_BLOCK, MAX_MULTICHANNEL_CHANNELS,
};
